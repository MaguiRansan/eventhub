...
class EventFormSubmissionTest(BaseEventTestCase):
    ...
    def test_event_creation(self):
        ...
        expected_url = reverse("event_detail", args=[new_event.id])

        self.assertEqual(new_event.organizer, self.organizer)
        self.assertEqual(new_event.general_tickets_available, 80) 
        self.assertEqual(new_event.vip_tickets_available, 40) 
